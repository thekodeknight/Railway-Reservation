...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<table border="0" cellspacing="0" cellpadding="0" width="440">
		<tr>
		<td class="pageHeader">Train Schedule</td>
		</tr>

		<tr>
		<td class="bodyText"><p>Select your Train from the given list</p>
...
<%
 ...
 %>
<form action="RouteHandler.jsp" method="get">
   
    Train:  <select name="Trainlist">
        <%                    
        while (rs.next()) {
        %> <option value="<%=rs.getString(2) + "," + rs.getInt(1)%>"><%=rs.getString(2)+" ("+rs.getString(1)+")"%> </option>           
        <%      
        }
        rs.close();
        ps.close();  
