...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<table border="0" cellspacing="0" cellpadding="0" width="440">
		<tr>
		<td class="pageHeader">Train Route</td>
		</tr>

		<tr>
                    <td class="bodyText" style="font-size:10pt"><p>   You Queried for
                            <%@ page language="java" import="java.sql.*, java.io.*, java.lang.*" %>
                            <% String Train=request.getParameter("Trainlist");
                               String arr[]=Train.split(",");
                               String Trainname = arr[0];
                               int Trainno = Integer.parseInt(arr[1]);%>
                        <%=Trainname%>  </p>
   <%  try {Class.forName("oracle.jdbc.driver.OracleDriver"); // Oracle Driver
    ...
    con = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521/XE","govind","270289gk");
     ...
     %>
     <table border="6" style="font-size:11pt" ><tr><th>Si no.</th><th>Station Code</th><th>Station name</th><th>Arrival Time</th><th>Dep. Time</th><th>Distance</th>
<%
   int count=1;  
     while (rs.next()) {
            out.println("<tr>\n<td>" + count + "</td>");count++;
