...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<table border="0" cellspacing="0" cellpadding="0" width="440">
		<tr>
		<td class="pageHeader">Please Log In :</td>
		</tr>
...
Username :<input type="text" name="username" value="" size="13" /><br>
Password :<input type="password" name="password" maxlength="10" size="14" value=""/>
<br>
<input type="submit" name="Login" value="Login">
</form>
If you have not registered please sign in here <a href="userform.jsp">REGISTER</a>
