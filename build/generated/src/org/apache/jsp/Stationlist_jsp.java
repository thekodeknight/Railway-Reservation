...
public final class Stationlist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                <tr>\n");
      out.write("                    <td class=\"pageHeader\">Stations List</td>\n");
      out.write("                </tr>\n");
      out.write("                \n");
      out.write("                <tr>\n");
      out.write("                    <td class=\"bodyText\"><p>List of all Stations with codes:</p>\n");
      out.write("                        \n");
      out.write("                        ");
                        ...
                        out.println("<table border=\"6\" style=\"font-size:9pt\" width=\"300\"><tr><th>Si no.</th><th>Station Code</th><th>Station name</th>");
                            
                            int count=1;  
                            while ( rs.next() ) {
                            out.println("<tr>\n<td>" + count + "</td>");count++;
                            out.println("<td>" + rs.getString(1) + "</td>" + "</td>");
