...
public final class FareEnquiry_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t<tr>\n");
      out.write("\t\t<td class=\"pageHeader\">Fare Enquiry For A Train</td>\n");
      out.write("\t\t</tr>\n");
      out.write("\n");
      out.write("\t\t<tr>\n");
      out.write("\t\t<td class=\"bodyText\"><p>Find fare for a particular train b/w two stations:\n");
      out.write("\n");
      out.write("</p>\n");
      out.write("\n");
 ...
 try {Class.forName("oracle.jdbc.driver.OracleDriver"); // Oracle Driver
    ...
    con = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521/XE","govind","270289gk");
     ...
     ResultSet rs = ps.executeQuery();  
      ...
      out.write("\n");
      out.write("<form action=\"FareHandler.jsp\" method=\"get\">\n");
      out.write("   \n");
      out.write("    Train:  <select name=\"Trainlist\">\n");
      out.write("        ");
     ...
     insertStmt= "SELECT * FROM STATION";
     ps = con.prepareStatement(insertStmt);
     rs = ps.executeQuery();  
      ...
      out.write("    </select>                \n");
      out.write("<br><br>\n");
      out.write("<input type=\"submit\" value=\"Get Fare\" name=\"Get Fare\">\n");
      out.write("</form>\n");
      out.write("\n");
      out.write("\n");
      out.write("\t\t <br />\t\t</td>\n");
