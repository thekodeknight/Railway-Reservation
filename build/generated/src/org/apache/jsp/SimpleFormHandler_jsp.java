...
public final class SimpleFormHandler_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t<td height=\"36\" colspan=\"3\" id=\"navigation\" nowrap=\"nowrap\" class=\"navText\"><a href=\"javascript:;\">HOME</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;\n");
      out.write("      <a href=\"/Images/railways.jpg\">TRAIN SCHEDULE</a>&nbsp;&nbsp;&nbsp;&nbsp; <a href=\"javascript:;\">PNR ENQUIRY</a>&nbsp;\n");
      out.write("      &nbsp;&nbsp;&nbsp; <a href=\"javascript:;\">FARES</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;\n");
      out.write("      <a href=\"javascript:;\">RESERVATION</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href=\"javascript:;\">INFORMATION</a>&nbsp;&nbsp;&nbsp;&nbsp;</td>\n");
      ...
      out.write("\t\t<tr>\n");
      out.write("\t\t<td class=\"pageHeader\">Train Route</td>\n");
      out.write("\t\t</tr>\n");
      out.write("\n");
      out.write("\t\t<tr>\n");
      out.write("\t\t<td class=\"bodyText\"><p>You Queried for </p>\n");
      out.write("   \n");
      out.write("    ");
 String Trainname=request.getParameter("Trainlist");
      out.write("\n");
      out.write("    ");
      out.print(Trainname);
      out.write("\n");
  ...
  try {Class.forName("oracle.jdbc.driver.OracleDriver"); // Oracle Driver
    ...
    con = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521/XE","govind","270289gk");
     String insertStmt= "SELECT trainno FROM TRAINS WHERE trainname = ?";
     ps = con.prepareStatement(insertStmt);
     ps.setString(1,Trainname);
     ResultSet rs = ps.executeQuery();rs.next();
     int trainno=rs.getInt(1);
     insertStmt= "SELECT * FROM STATION,STOP WHERE STATION.stncode=STOP.stncode AND STOP.trainno= ? ORDER BY distance";
     ps = con.prepareStatement(insertStmt);
     ps.setInt(1,trainno);
     rs = ps.executeQuery();
     
      out.write("\n");
      out.write("     <table border=\"6\" style=\"font-size:10pt\" ><tr><th>Station Code</th><th>Station name</th><th>Arrival Time</th><th>Dep. Time</th><th>Distance</th>\n");
     ...
     while ( rs.next() ) {
            ...
            out.println("<td>" + rs.getString(8) + "</td>" + "</td>\n</tr>");
        }
        rs.close();
     ps.close();   
