...
public final class TrainHandler_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 try {Class.forName("oracle.jdbc.driver.OracleDriver"); // Oracle Driver
    ...
    String insertStmt= "SELECT trainno,distance FROM STATION,STOP WHERE STATION.stnname= ? AND STATION.stncode=STOP.stncode";
     ...
     ps.setString(1,Source);ResultSet rs;
...
out.println("<td>" + count + "</td>");count++;
                        ...
                        out.println("<td>" + rs2.getString(5) + "</td>" + "</td>");
                        out.println("<td>" + rs2.getString(6) + "</td>" + "</td>");
                        out.println("<td>" + rs2.getString(7) + "</td>" + "</td>");
                        out.println("<td>" + rs2.getString(8) + "</td>" + "</td>");
                        ...
                        }catch(SQLException e){out.println("ClassNotFoundException: " + e.getMessage());}    
                        rs.close();
                        ps.close();   
                        con.close();
