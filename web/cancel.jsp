...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<table border="0" cellspacing="0" cellpadding="0" width="440">
		<tr>
		<td class="pageHeader">Ticket Cancellation</td>
		</tr>

		<tr>
		<td class="bodyText"><p>Please enter 10 digit PNR Number, printed on the top left corner of your ticket for cancelling.

</p>
<%@ page language="java" import="java.sql.*, java.io.*, java.lang.*" %>

<form action="cancelHandler.jsp" method="get">
